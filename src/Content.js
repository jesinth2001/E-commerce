...
const arr = [{"id":1,"image":"Apple13pro.jpg" ,"name":"Apple Iphone 13 Pro","specs":"6GB RAM 128GB Internal Storage color-Pink","price":"₹69,900","ram":"6GB","rom":"128GB",
                                                                                           "Brand":"Apple"},
             {"id":2,"image":"Apple14pro.jpg" ,"name":"Apple Iphone 14 Pro","specs":"8GB RAM  128GB Internal Storage color-Purple","price":"₹79,900","ram":"8GB","rom":"128GB",
                                                                                      "Brand":"Apple"},
             ...
             {"id":7,"image":"lava z6.jpg" ,"name":"lava Z6 Pro","specs":" 6GB RAM 64GB Internal Storage color-Aqua Blue","price":"₹10,999","ram":"6GB","rom":"64GB",
                                                                                             "Brand":"Lava"},
...
const Content=(props)=>
{
  ...
  const [count,setCount,filter,setFilter,setter,setSetter]=useContext(cardContext);
...
const search=(e)=>
{
  ...
  const selectbrand=(gb,sf,f)=>
  {
       ...
       if(f.indexOf(gb)===-1)
      {
        document.getElementById(gb).style.color="rgb(19, 192, 120)";
    ...
    document.getElementById(gb).style.color="white";
    let ff=[...f] 
    ff.splice(f.indexOf(gb),1)
    sf(ff) 
...
return(<div class={props.className}>
                       ...
                       <Sidebarsrch className="sdiv" >  </Sidebarsrch>
                       {setter}
                       <Suggestions className="suggestionbox"> </Suggestions>
                                      ...
                                      if(filter.length===0)
                                      {
                                       ...
                                       {  
                                              ...
                                              if(filter.length==1)
                                              {
                                                 ...
                                                 if((filter.indexOf(element.Brand)!==-1 )||(filter.indexOf(element.rom)!==-1)||
                                                 (filter.indexOf(element.ram)!==-1))
                                                 {
                                                  return(<Shoppingcard className="shopcard">
                                              ...
                                              else 
                                              {
                                                 ...
                                                 if(( filter.indexOf(element.rom)!==-1 &&filter.indexOf(element.Brand)!==-1||filter.indexOf(element.ram)!==-1 && filter.indexOf(element.Brand)!==-1
